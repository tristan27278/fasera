        ...
        <div class="box">
            ...
            <form>
                <div class="form-group">
                    ...
                    <input type="text" placeholder="Masukkan judul laporan" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" placeholder="Contoh: Ruang Kelas, Kantin" required>
                </div>

                <div class="form-group">
                    <label>Keterangan</label>
                    <textarea rows="5" placeholder="Jelaskan kejadian secara lengkap" required></textarea>
                </div>
